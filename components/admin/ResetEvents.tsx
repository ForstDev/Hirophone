  ...
  return (
    <div className="flex items-center gap-2 rounded-full border border-orange-500 bg-orange-50 px-3 py-2">
      ...
      <button
        onClick={reset}
        disabled={pending}
        className="rounded-full bg-orange-600 px-3 py-1.5 text-[11.5px] font-bold text-white transition enabled:active:scale-[0.97] hover:bg-orange-700 disabled:opacity-60"
      >
