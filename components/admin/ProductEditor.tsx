        ...
        <footer className="sticky bottom-0 border-t border-line bg-paper px-5 py-4">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              onClick={save}
              disabled={busy}
              className="flex-1 rounded-full bg-orange-600 px-5 py-4 text-[12.5px] font-bold text-white transition enabled:active:scale-[0.98] hover:bg-orange-700 disabled:bg-line-strong"
            >
